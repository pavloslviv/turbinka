...
function prepareThemeCustomStyles() {
    ...
    $clr3 = '';
    if (empty($clr3))
        $clr3 = get_custom_option('main_menu_color');
    if (!empty($clr3)) {
        $custom_style .= '
        ...
        $custom_style = apply_filters('theme_skin_set_main_menu_color', $custom_style, $clr3);
    }
...
.theme_accent,
.topWrap .usermenu_area .phone_number, .topWrap .usermenu_area a, .menu_item_description, .logo .logo_slogan,
.topTabsWrap .speedBar a:hover,
.topWrap .topMenuStyleLine > ul li.current-menu-item > a, .topWrap .topMenuStyleLine ul > li.current-menu-parent > a,
.topWrap .topMenuStyleLine > ul > li.current-menu-ancestor > a,.topWrap .topMenuStyleLine > ul > li > a:hover,
.infoPost a:hover,
...
.sc_toggles.sc_toggles_style_2 .sc_toggles_item.sc_active .sc_toggles_title:hover,
...
.post article div.isotopeFiltr > ul > li.roundButton.active a,.post article div.isotopeFiltr > ul > li.roundButton a:hover,
.sc_blogger a:hover,
...
.footerStyleDark .widget_area .roundButton > a
{ color:'.$clr.' !important; }
...
.roundButton > a:active,
.roundButton.dark > a:active,
.roundButton.border > a:hover,
...
.ih-item.round.effect15.colored .info { background:'.$clr.'; }
...
';
	...
	if (!empty($clr) || !empty($fore_clr)) {
		...
		$custom_style .= '
			.logo, .logo_text,.logo a,.openRightMenu:hover:before,.topMenuStyleLine ul#mainmenu .menu-panel .item_placeholder .item_title,.topMenuStyleLine ul#mainmenu .menu-panel .item_placeholder .item_title a,.topMenuStyleLine ul#mainmenu .menu-panel.thumb .item_placeholder .item_title,.topMenuStyleLine ul#mainmenu .menu-panel.thumb .item_placeholder .item_title a,.topMenuStyleLine ul#mainmenu .menu-panel .item_placeholder .item_info > * > span,.topMenuStyleLine ul#mainmenu .menu-panel .item_placeholder .item_info > * > em,.topMenuStyleLine ul#mainmenu .menu-panel ul.columns > li a,.top_panel_above .fullScreenSlider .topWrap .topMenuStyleLine > ul > li a,.topMenuStyleLine ul#mainmenu > li ul li a .menu_icon
			{ color: '.$clr.';	}
