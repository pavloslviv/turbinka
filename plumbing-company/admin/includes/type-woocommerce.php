...
if ( !function_exists( 'themerex_woocommerce_get_product_search_form' ) ) {
	function themerex_woocommerce_get_product_search_form($form) {
		...
		<form role="search" method="get" class="search-form" action="' . esc_url( home_url( '/'  ) ) . '">
			<input type="text" class="search-field" placeholder="' . __('Search for products &hellip;', 'themerex') . '" value="' . get_search_query() . '" name="s" title="' . __('Search for products:', 'themerex') . '" /><span class="search-button roundButton light ico"><a class="search-field icon-search" href="#"></a></span>
