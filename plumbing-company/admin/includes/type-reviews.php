...
if ( !function_exists( 'getReviewsMarkup' ) ) {
	function getReviewsMarkup($field, $value, $editable=false, $clear=false, $snippets=false) {
		...
		$output .= isset($field['accept']) && $field['accept'] ? '<div class="accept"><div class="roundButton global"><a href="#" title="'.__('Accept your votes', 'themerex').'">'.__('Accept', 'themerex').'</a></div></div>' : '';
