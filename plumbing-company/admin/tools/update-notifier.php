...
define( 'NOTIFIER_THEME_NAME', 'Plumbing' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'default' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_plumbing.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
