...
if (is_themerex_options_used()) {
	...
	//$socials 		= getSocialsList();  /*use social icons images*/
	$socials 		= getSocialIconsList();
	$icons 			= getIconsList();
	...
	$animationsin   = themerex_get_list_animations_in();
	$animationsout   = themerex_get_list_animations_out();
} else {
	$headers = $skins = $hovers = $hovers_dir = $fonts = $fonts_styles = $themes = $socials = $icons = $categories = $posts_types = $menus = $sidebars = $positions = $body_styles = $blog_styles = $single_styles = $sliders = $popups = $gmap_styles = $dir = $yes_no = $on_off = $show_hide = $sorting = $ordering = $locations = $animationsin = $animationsout = array();
}
...
$THEMEREX_options[] = array( "title" => __('General W`P`L`O`C`K`E`R`.`C`O`M`', 'themerex'),
...
$THEMEREX_options[] = array( "title" => __('Fixed banner', 'themerex'),
			"desc" => __('Fixed banner on the right of the screen.', 'themerex'),
			"override" => "category,page,post",
			"type" => "info");

$THEMEREX_options[] = array( "title" => __('Banner image',  'themerex'),
			"desc" => __('Select or upload banner image.',  'themerex'),
			"id" => "fixed_banner_image",
			"override" => "category,post,page",
			"std" => "",
			"type" => "media");

$THEMEREX_options[] = array( "title" => __('Fixed banner link',  'themerex'),
			"desc" => __("Insert your link if needed)", 'themerex'),
			"id" => "fixed_banner_link",
			"override" => "category,post,page",
			"std" => "",
			"type" => "text");
...
$THEMEREX_options[] = array( "title" => __('Your HTML/JS code',  'themerex'),
			"desc" => __('Put here your invisible html/js code',  'themerex'),
			"id" => "custom_code",
			"override" => "category,post,page",
			"cols" => 80,
			"rows" => 20,
...
$THEMEREX_options[] = array( "title" => __('Custom icon', 'themerex'),
            "desc" => __('You can choose custom icon with a link for your site.', 'themerex'),
            "override" => "category,post,page",
            "type" => "info");

$THEMEREX_options[] = array( "title" => __('Show accredited icon', 'themerex'),
            "desc" => __("Show accredited icon at the top right corner of the page", 'themerex'),
            "id" => "show_accredited_icon",
            "override" => "category,post,page",
            "std" => "no",
            "options" => $yes_no,
            "type" => "switch");

$THEMEREX_options[] = array( "title" => __('Accredited icon', 'themerex'),
            "desc" => __('Accredited icon', 'themerex'),
            "id" => "accredited_icon",
            "override" => "category,post,page",
            "divider" => false,
            "std" => "",
...
$THEMEREX_options[] = array( "title" => __('Accredited icon link',  'themerex'),
            "desc" => __("Link for Accredited icon", 'themerex'),
            "id" => "accredited_icon_link",
            "override" => "category,post,page",
            "divider" => false,
            "std" => "",
            "type" => "text");

$THEMEREX_options[] = array( "title" => __("Top position (in percents)", 'themerex'),
            "desc" => __("Set the top position your icon (in percents)", 'themerex'),
            "id" => "vertical_accredited",
            "override" => "category,page,post",
            "std" => 50,
            "min" => 0,
            //"increment" => 10,
...
$THEMEREX_options[] = array( "title" => __('Left ot Right position', 'themerex'),
            "desc" => __('Choose position your icon (left or right)', 'themerex'),
            "id" => "horizontal_accredited",
            "override" => "category,page,post",
            "std" => "left",
            "options" => array(
...
$THEMEREX_options[] = array( "title" => __('Menu elements color',  'themerex'),
            "desc" => __('Select color of the main menu and search icon', 'themerex'),
            "id" => "main_menu_color",
            "override" => "category,post,page",
            "std" => "",
            "type" => "color");
...
$THEMEREX_options[] = array( "title" => __('Show Work Time', 'themerex'),
			"desc" => __("Show work time at the top left corner of the page", 'themerex'),
			"id" => "show_work_time",
			"override" => "category,post,page",
			"std" => "yes",
			"options" => $yes_no,
...
$THEMEREX_options[] = array( "title" => __('Work time', 'themerex'),
             "desc" => __('String with work time', 'themerex'),
             "id" => "work_time",
             "std" => "",
...
//User Area text from Right
$THEMEREX_options[] = array( "title" => __('Show text 1 from the right part', 'themerex'),
            "desc" => __("Show the text from the right part of area", 'themerex'),
            "divider" => true,
            "id" => "show_text1_right_side",
            "override" => "category,post,page",
            "std" => "yes",
            "options" => $yes_no,
            "type" => "switch");

$THEMEREX_options[] = array( "title" => __('Text 1 from the right', 'themerex'),
            "desc" => __('Add text if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_text1_link_right",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");

$THEMEREX_options[] = array( "title" => __('Link for text 1', 'themerex'),
            "desc" => __('Add link for text 1 if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_link1_right",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");


$THEMEREX_options[] = array( "title" => __('Show text 2 from the right part', 'themerex'),
			"desc" => __("Show the text from the right part of area", 'themerex'),
            "divider" => true,
			"id" => "show_text2_right_side",
			"override" => "category,post,page",
			"std" => "yes",
			"options" => $yes_no,
			"type" => "switch");

$THEMEREX_options[] = array( "title" => __('Text 2 from the right', 'themerex'),
            "desc" => __('Add text if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_text2_link_right",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");

$THEMEREX_options[] = array( "title" => __('Link for text 2', 'themerex'),
            "desc" => __('Add link for text 2 if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_link2_right",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");


//User Area text from Left
$THEMEREX_options[] = array( "title" => __('Show text 1 from the left part', 'themerex'),
            "desc" => __("Show the text 1 from the left part of area", 'themerex'),
            "id" => "show_text1_left_side",
            "override" => "category,post,page",
            "std" => "yes",
            "options" => $yes_no,
            "type" => "switch");

$THEMEREX_options[] = array( "title" => __('Text 1 from the left', 'themerex'),
            "desc" => __('Add text if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_text1_link_left",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");

$THEMEREX_options[] = array( "title" => __('Link for text 1', 'themerex'),
            "desc" => __('Add link for text if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_link1_left",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");

$THEMEREX_options[] = array( "title" => __('Show text 2 from the left part', 'themerex'),
            "desc" => __("Show the text 2 from the left part of area", 'themerex'),
            "id" => "show_text2_left_side",
            "override" => "category,post,page",
            "std" => "yes",
            "options" => $yes_no,
            "type" => "switch");

$THEMEREX_options[] = array( "title" => __('Text 2 from the left', 'themerex'),
            "desc" => __('Add text if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_text2_link_left",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");
...
$THEMEREX_options[] = array( "title" => __('Link for text 2', 'themerex'),
            "desc" => __('Add link for text if you need', 'themerex'),
            "divider" => false,
            "id" => "contact_link2_left",
            "std" => "",
            "before" => array('icon'=>'iconadmin-link'),
            "type" => "text");


$THEMEREX_options[] = array( "title" => __('Show Social Links', 'themerex'),
			"desc" => __("Show Social Links at the center of the area", 'themerex'),
			"id" => "show_socials",
			"override" => "category,post,page",
			"std" => "yes",
			"options" => $yes_no,
...
$THEMEREX_options[] = array( "title" => __("Header &amp; Footer - W_P_L_O_C_K_E_R_._C_O_M", 'themerex'),
...
$THEMEREX_options[] = array( "title" => __('Hover dir', 'themerex'),
			"desc" => __('Select hover direction (only for Blog style = Portfolio and Hover style = Circle or round)', 'themerex'),
			"id" => "hover_dir",
			"override" => "category,page",
			"std" => "dir",
			"options" => $hovers_dir,
