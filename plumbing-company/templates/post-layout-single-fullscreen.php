			...
			<div class="post_info infoPost">
				<?php if ($post_data['post_edit_enable'] || $post_data['post_delete_enable']) { ?>
					<span class="frontend_editor_buttons">
						...
						<span class="roundButton light ico"><a id="frontend_editor_icon_edit" class="icon-brush" title="<?php _e('Edit post', 'themerex'); ?>" href="#"><?php _e('Edit', 'themerex'); ?></a></span>
						<?php } ?>
						<?php if ($post_data['post_delete_enable']) { ?>
						<span class="roundButton light ico"><a id="frontend_editor_icon_delete" class="icon-trash-1" title="<?php _e('Delete post', 'themerex'); ?>" href="#"><?php _e('Delete', 'themerex'); ?></a></span>
						<?php } ?>
					</span>
				<?php } ?>
				...
				<?php _e('by', 'themerex'); ?> <span class="vcard" itemprop="author"><a href="<?php echo esc_url($post_data['post_author_url']); ?>" class="post_author fn" rel="author"><?php echo ($post_data['post_author']); ?></a></span>
			...
			if ($post_data['post_protected']) { 
				...
				<div class="tagsWrap">
					...
					<div class="infoPost">
						...
						<?php echo ($post_data['post_tags_links']); ?>
					</div>
					<?php } ?>
				</div>
				<?php 
