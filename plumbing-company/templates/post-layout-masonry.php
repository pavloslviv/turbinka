...
<article class="isotopeElement <?php 
	...
	<div class="isotopePadding">
        ...
        echo "<div class='sc_blogger_content-wrap'>";
		if ($show_title) {
        ...
        <?php
            if ($opt['readmore'] != '' ) {
            echo do_shortcode('[trx_button link="'.esc_url($post_data['post_link']).'" class="sc_button sc_button_style_dark filled sc_button_size_medium filledButton dark medium"]'.$opt['readmore'].'[/trx_button]');
            }
        ?>
		...
		<div class="masonryInfo"><?php _e('Posted ', 'themerex'); ?><a href="<?php echo esc_url($post_data['post_link']); ?>" class="post_date"><?php echo esc_html($post_data['post_date']); ?></a></div>
