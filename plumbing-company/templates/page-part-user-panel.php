...
<?php
	if (get_custom_option('show_login')=='yes') {
		...
		if ( !is_user_logged_in() ) {
			...
			themerex_enqueue_script( 'magnific', themerex_get_file_url('/js/magnific-popup/jquery.magnific-popup.min.js'), array('jquery'), null, true );
			?>
			<li class="usermenu_login sc_button sc_button_style_global filled sc_button_size_medium filledButton global medium"><a href="#user-popUp" class="user-popup-link"><?php _e('Login', 'themerex'); ?></a></li>
			<?php 
		} else {
			$current_user = wp_get_current_user();
			?>
			<li class="usermenu_controlPanel sc_button sc_button_style_global filled sc_button_size_medium filledButton global medium">
				<a href="#" class=""><span><?php echo esc_html($current_user->display_name); ?></span></a>
				<ul>
