...
THEMEREX_PHONE_EMPTY		  = "<?php echo addslashes(__('Phone number too short', 'themerex')); ?>";
THEMEREX_PHONE_LONG 		  = "<?php echo addslashes(__('Phone number too long', 'themerex')); ?>";
THEMEREX_PHONE_NOT_VALID 	  = "<?php echo addslashes(__('Invalid phone', 'themerex')); ?>";
