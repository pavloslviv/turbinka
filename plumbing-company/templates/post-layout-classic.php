...
<article class="isotopeElement <?php 
	...
	<div class="isotopePadding">
		...
		?>
		<div class="thumb" data-image="<?php echo esc_url($post_data['post_attachment']); ?>" data-title="<?php echo esc_attr($post_data['post_title']); ?>"><?php echo balanceTags($post_data['post_thumb']); ?>
			<div class="link-wrapper">
				<a href="<?php echo esc_url($post_data['post_link']); ?>">View</a>
			</div>
		</div>
		<?php
