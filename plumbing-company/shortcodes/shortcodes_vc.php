...
if ( !function_exists( 'themerex_shortcodes_vc_scripts_admin' ) ) {
	...
	function themerex_shortcodes_vc_scripts_admin() {
		...
		// Include JS
		themerex_enqueue_script( 'shortcodes_vc', themerex_get_file_url('/shortcodes/shortcodes_vc_admin.js'), array(), null, true );
	}
}
...
if ( !function_exists( 'themerex_shortcodes_vc_theme_setup' ) ) {
	add_action( 'after_setup_theme', 'themerex_shortcodes_vc_theme_setup', 20 );
...
vc_remove_element("vc_wp_text");
			...
			global $THEMEREX_shortcodes_list_styles, $THEMEREX_shortcodes_yes_no, $THEMEREX_shortcodes_on_off, $THEMEREX_shortcodes_dir, $THEMEREX_shortcodes_align, $THEMEREX_shortcodes_float, $THEMEREX_shortcodes_show_hide, $THEMEREX_shortcodes_sorting, $THEMEREX_shortcodes_ordering, $THEMEREX_shortcodes_sliders, $THEMEREX_shortcodes_users, $THEMEREX_shortcodes_categories, $THEMEREX_shortcodes_columns, $THEMEREX_shortcodes_images, $THEMEREX_shortcodes_icons, $THEMEREX_shortcodes_locations, $THEMEREX_shortcodes_blogger_styles, $THEMEREX_shortcodes_filters, $THEMEREX_shortcodes_formats, $THEMEREX_shortcodes_googlemap_styles, $THEMEREX_shortcodes_hovers, $THEMEREX_shortcodes_hovers_dir, $THEMEREX_shortcodes_tint, $THEMEREX_shortcodes_field_types;
...
vc_map( array(
	...
	"params" => array(
		...
		array(
            ...
            "description" => __("Select hover direction (only if style=Portfolio and hover=Circle|round)", "themerex"),
			"class" => "",
		...
		array(
			"param_name" => "info",
			"heading" => __("Don't show info", "themerex"),
            "description" => __("Show post info block (author, date, tags, etc.)", "themerex"),
			"class" => "",
			"value" => array(__("Don't show info", 'themerex') => 'no'),
			"type" => "checkbox"
        ),
		array(
			"param_name" => "descr",
...
vc_map( array(
	...
	"params" => array(
        ...
        array(
            "param_name" => "type",
            "heading" => __("Button's background style", "themerex"),
            "description" => __("Select button's background style", "themerex"),
            "class" => "",
            "value" => array(
                __('Transparent', 'themerex') => 'transparent',
...
vc_map( array(
	...
	"content_element" => true,
	"is_container" => true,
				"as_parent" => array('excerpt' => 'trx_contact_form'),
	"show_settings_on_create" => true,
	"params" => array(
		array(
			"param_name" => "style",
			"heading" => __("Contact Form style", "themerex"),
			"description" => __("Select style for display contact form", "themerex"),
			"class" => "",
			"admin_label" => true,
			"value" => array(
				__('Style 1', 'themerex') => 1,
...
vc_map( array(
	...
	"content_element" => true,
	"is_container" => false,
				"as_child" => array('only' => 'trx_contact_form,trx_column_item'), // Use only|except attributes to limit parent (separate multiple values with comma)
	"params" => array(
		array(
			"param_name" => "type",
...
vc_map( array(
	...
	"params" => array(
		array(
			...
			"description" => __("Select style for Countdown", "themerex"),
			"class" => "",
			"admin_label" => true,
			"value" => array(
...
vc_map( array(
	...
	"params" => array(
		...
		array(
            ...
            "description" => __("Shape of the image: round or round", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array(
				__('round', 'themerex') => 'round',
...
vc_map( array(
	...
	"params" => array(
		...
		array(
            ...
            "description" => __("Author's position", "themerex"),
			"class" => "",
			"value" => "",
			"type" => "textfield"
        ),
...
vc_map( array(
	...
	"params" => array_merge(array(
		...
		array(
			"param_name" => "alias",
			"heading" => __("Revolution slider alias", "themerex"),
            "description" => __("Alias for Revolution slider", "themerex"),
			"admin_label" => true,
			"class" => "",
	        'dependency' => array(
				'element' => 'engine',
...
/*
					array(
						"param_name" => "content",
						"heading" => __("Content", "themerex"),
						"description" => __("Description for the team item", "themerex"),
						"class" => "",
						"value" => "",
						"type" => "textarea_html"
					),
...
class WPBakeryShortCode_Trx_Team extends THEMEREX_VC_ShortCodeColumns {}
			class WPBakeryShortCode_Trx_Team_Item extends THEMEREX_VC_ShortCodeContainer {}
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"heading" => __("Show Controls", "themerex"),
			"description" => __("Show Slider controls or not.", "themerex"),
			"admin_label" => true,
			"class" => "",
			"value" => array(__('Show Controls', 'themerex') => 'yes'),
			"type" => "checkbox",
...
vc_map( array(
	...
	"params" => array(
        array(
            "param_name" => "link",
            "heading" => __("Link URL", "themerex"),
            "description" => __("Link URL from this title (if not empty)", "themerex"),
            "admin_label" => true,
            "class" => "",
            "value" => "",
            "type" => "textfield"
		...
		array(
            ...
            "description" => __("Title font letter spacing in px", "themerex"),
			"class" => "",
			"value" => array(
				__('0', 'themerex') => '0',
				__('1', 'themerex') => '1',
	...
	vc_map( array(
		...
		"show_settings_on_create" => false,
					"params" => array(
						array(
							"param_name" => "dummy",
							"heading" => __("Dummy data", "themerex"),
							"description" => __("Dummy data - not used in shortcodes", "themerex"),
							"class" => "",
							"value" => "",
							"type" => "textfield"
						)
