...
$THEMEREX_shortcodes = array(
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"desc" => __("Description for the popup (then hover on the icon).", "themerex"),
				"value" => "",
				"type" => "text"
			),
			array(
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"desc" => __("Select hover direction (only if style=Portfolio and hover=Circle|round)", "themerex"),
				"dependency" => array(
					'style' => array('portfolio'),
					'hover' => array('round','circle')
				),
				"value" => "left_to_right",
				"type" => "select",
	...
	array(
		...
		"params" => array(
            ...
            array(
                "id" => "type",
                "title" => __("Button's background style", "themerex"),
                "desc" => __("Select button's background style", "themerex"),
                "value" => "transparent",
                "type" => "switch",
                "size" => "medium",
                "options" => array(
	...
	array(
		...
		"params" => array(
			array(
				"id" => "style",
				"title" => __("Contact Form style", "themerex"),
				"desc" => __("Select style for display contact form", "themerex"),
				"value" => 1,
				"options" => array(
					1 => __('Style 1', 'themerex'),
					2 => __('Style 2', 'themerex'),
	...
	array(
		...
		"params" => array(
			array(
				...
				"desc" => __("Select style for Countdown", "themerex"),
				"value" => 'round',
				"options" => array(
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"desc" => __("Shape of the image: round (rectangle) or round", "themerex"),
				"value" => "round",
				"type" => "checklist",
				"dir" => "horizontal",
				"options" => array(
	...
	array(
		...
		"params" => array(
			...
			array(
				...
				"desc" => __("Author's position", "themerex"),
				"value" => "",
				"type" => "text"
			),
			array(
	...
	array(
		...
		"params" => array_merge(array(
			...
			array(
				"id" => "alias",
				"title" => __("Revolution slider alias", "themerex"),
				"desc" => __("Alias for Revolution slider", "themerex"),
				"dependency" => array(
					'engine' => array('revo')
				),
				"divider" => true,
	...
	array(
		...
		"params" => array(
			...
			array(
				"id" => "showcontrols",
				"title" => __("Show Controls", "themerex"),
				"desc" => __("Show Slider controls or not.", "themerex"),
				"divider" => true,
				"value" => "no",
				"type" => "switch",
				"options" => $THEMEREX_shortcodes_yes_no
	...
	array(
		...
		"params" => array(
            array(
                "id" => "link",
                "title" => __("Link URL", "themerex"),
                "desc" => __("Link URL from this title (if not empty)", "themerex"),
                "value" => "",
                "type" => "text"
            ),
			array(
			...
			array(
				...
				"desc" => __("Title font letter spacing in px", "themerex"),
				"value" => "",
				"type" => "select",
				"size" => "medium",
				"options" => array(
...
function themerex_shortcodes_load_scripts() {
	...
	themerex_enqueue_script( 'themerex-jssubscribe-script',  themerex_get_file_url('/js/jssubscribe.js'), array('jquery'), null, true );
}
...
if ( !function_exists( 'themerex_shortcodes_is_used' ) ) {
	function themerex_shortcodes_is_used() {
		return is_themerex_options_used() 															// All modes when Theme Options are used
