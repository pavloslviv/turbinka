...
?>
	...
	<section id="comments" class="comments hrShadow">
		<h2 class="comments_title"><?php echo esc_html($post_comments = get_comments_number()); ?> <?php echo ($post_comments==1 ? __('Comment', 'themerex') : __('Comments', 'themerex')); ?></h2>
		...
		<div class="commForm commentsForm">
			...
			$comments_args = array(
					...
					'comment_field' => '<div class="message">'
										...
										. '<div class="sc_button sc_button_style_global global medium ico comm"><a class="enter" href="#">' . __('Post comment', 'themerex') . '</a></div>'
										. '</div>',
		...
		default :
			...
			<li id="comment-<?php comment_ID(); ?>" <?php comment_class('commItem'); ?>>
				<div class="replyWrap">
					...
					<div class="roundButton ico reply comment_reply"><?php comment_reply_link( array_merge( $args, array( 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?></div>
					<?php } ?>
				</div>
